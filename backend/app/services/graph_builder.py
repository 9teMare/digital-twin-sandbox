...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "Digital Twin Agent Sandbox Graph",
        chunk_size: int = 500,
    ...
    def create_graph(self, name: str) -> str:
        """创建Zep图谱（公开方法）"""
        graph_id = f"digital_twin_agent_sandbox_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="Digital Twin Agent Sandbox Social Simulation Graph"
        )
